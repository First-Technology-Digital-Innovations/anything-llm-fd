...
export function BingSearchOptions({ settings }) {
  return (
    <>
      <p className="text-sm text-white/60 my-2">
        Configure the Azure Foundry agent for web search.
      </p>
      <div className="flex gap-x-4">
        <div className="flex flex-col w-96">
          ...
          <input
            type="url"
            name="env::AgentBingSearchEndpoint"
            className="border-none bg-theme-settings-input-bg text-white placeholder:text-theme-settings-input-placeholder text-sm rounded-lg focus:outline-primary-button active:outline-primary-button outline-none block w-full p-2.5"
            placeholder="https://your-foundry.services.ai.azure.com/api/projects/proj-xxx"
            defaultValue={settings?.AgentBingSearchEndpoint || ""}
            required={true}
            autoComplete="off"
            spellCheck={false}
          />
        ...
        <div className="flex flex-col w-96">
          ...
          <input
            type="text"
            name="env::AgentBingSearchAgentname"
            className="border-none bg-theme-settings-input-bg text-white placeholder:text-theme-settings-input-placeholder text-sm rounded-lg focus:outline-primary-button active:outline-primary-button outline-none block w-full p-2.5"
            placeholder="Agent name (e.g., BCPAI-WebSearchAgent)"
            defaultValue={settings?.AgentBingSearchAgentname || ""}
            required={true}
            autoComplete="off"
            spellCheck={false}
          />
      ...
      <p className="text-sm text-white/60 my-2 mt-4">
        To set up a Foundry web search agent:
      </p>
      <ol className="list-decimal text-sm text-white/60 ml-6">
        ...
        <li>Create or access your Azure AI Foundry project.</li>
        <li>Create a web search agent in the Foundry.</li>
        <li>
          Copy the project endpoint URL (e.g.,{" "}
          <code className="text-white/80">
            https://your-foundry.services.ai.azure.com/api/projects/proj-xxx
          </code>
          ).
        </li>
        <li>Enter the agent name (as configured in Foundry).</li>
      </ol>
    </>
  );
}
